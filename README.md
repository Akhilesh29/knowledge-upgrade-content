...
blinkit darkstore hld: <img width="1180" height="1646" alt="blinkit_darkstore_hld" src="https://github.com/user-attachments/assets/b2b5d801-053f-458e-9a65-233b5c54b93a" />
...
| RustDesk | [rustdesk/rustdesk](https://github.com/rustdesk/rustdesk) |
| Stirling PDF | [Stirling-Tools/Stirling-PDF](https://github.com/Stirling-Tools/Stirling-PDF) |
| Maybe Finance | [maybe-finance/maybe](https://github.com/maybe-finance/maybe) |
| OpenCut | [OpenCut-app/OpenCut](https://github.com/OpenCut-app/OpenCut) |
| uv (Astral) | [astral-sh/uv](https://github.com/astral-sh/uv) |
...
| FOSSA CLI | [fossas/fossa-cli](https://github.com/fossas/fossa-cli) |
| Anoma | [anoma/anoma](https://github.com/anoma/anoma) |
| Jan | [janhq/jan](https://github.com/janhq/jan) |
| LobeHub | [lobehub/lobe-chat](https://github.com/lobehub/lobe-chat) |
| MyShell (OpenVoice) | [myshell-ai/OpenVoice](https://github.com/myshell-ai/OpenVoice) |
| Builder.io (gpt-crawler) | [BuilderIO/gpt-crawler](https://github.com/BuilderIO/gpt-crawler) |
| ToolJet | [ToolJet/ToolJet](https://github.com/ToolJet/ToolJet) |
| Mastra | [mastra-ai/mastra](https://github.com/mastra-ai/mastra) |
| Turso (Limbo) | [tursodatabase/limbo](https://github.com/tursodatabase/limbo) |
| Browserbase (Stagehand) | [browserbase/stagehand](https://github.com/browserbase/stagehand) |
| Million (React Scan) | [aidenybai/react-scan](https://github.com/aidenybai/react-scan) |
| Maxun | [getmaxun/maxun](https://github.com/getmaxun/maxun) |
| Pathway | [pathwaycom/pathway](https://github.com/pathwaycom/pathway) |
| OmniAI (Zerox) | [getomni-ai/zerox](https://github.com/getomni-ai/zerox) |
| Gitingest (Coderamp) | [cyclotruc/gitingest](https://github.com/cyclotruc/gitingest) |
| stagewise | [stagewise-io/stagewise](https://github.com/stagewise-io/stagewise) |
| mcp-use (Manufact) | [mcp-use/mcp-use](https://github.com/mcp-use/mcp-use) |
| Sourcebot | [sourcebot-dev/sourcebot](https://github.com/sourcebot-dev/sourcebot) |
